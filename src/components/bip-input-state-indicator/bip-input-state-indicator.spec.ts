...
import { BipInputStateIndicatorComponent } from './bip-input-state-indicator';

describe('BipInputStateIndicatorComponent', () => {

  let fixture: ComponentFixture<BipInputStateIndicatorComponent>;
  let component: BipInputStateIndicatorComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(BipInputStateIndicatorComponent)
      ]
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(BipInputStateIndicatorComponent);
    component = fixture.componentInstance;
  });

  it("should throw an error when no 'input' value is provided", function() {
    expect(() => fixture.detectChanges()).to.throw(Error, "An 'bip-input-state-indicator' tag requires a value for its 'input' attribute.");
  });
  ...
  describe("with an 'input' value", () => {
    ...
    it('should compile and display nothing if the input is invalid without any user interaction', function() {
      ...
      expect(component).to.be.an.instanceOf(BipInputStateIndicatorComponent);
